...
const BRAND_META: Record<string, {
  ...
  "grammarly-premium-bangladesh": {
    ...
    seoDescription: "Grammarly Premium price in Bangladesh. AI grammar, spelling, tone and clarity checking. Pay with bKash/Nagad. Fast delivery. 30-day warranty.",
  ...
  "microsoft-copilot-pro-bangladesh": {
    ...
    seoDescription: "Microsoft Copilot Pro price in Bangladesh. AI assistant in Microsoft 365 apps. Pay with bKash/Nagad. Fast delivery. 30-day warranty.",
  ...
  "adobe-firefly-bangladesh": {
    ...
    seoDescription: "Adobe Firefly price in Bangladesh. AI image generation, generative fill, text effects. Commercial-safe. Pay with bKash/Nagad. Fast delivery.",
  ...
  "pika-labs-bangladesh": {
    ...
    seoDescription: "Pika Labs price in Bangladesh. Text-to-video AI generation. Pay with bKash/Nagad. Fast delivery.",
  ...
  "opus-clip-bangladesh": {
    ...
    seoDescription: "Opus Clip price in Bangladesh. AI video repurposing for Shorts, Reels, and TikTok. Pay with bKash/Nagad. Fast delivery.",
  ...
  "descript-pro-bangladesh": {
    ...
    seoDescription: "Descript Pro price in Bangladesh. AI video and podcast editing. Pay with bKash/Nagad. Fast delivery.",
  ...
  "murf-ai-bangladesh": {
    ...
    seoDescription: "Murf AI price in Bangladesh. 120+ AI voices in 20+ languages. Text-to-speech studio. Pay with bKash/Nagad. Fast delivery.",

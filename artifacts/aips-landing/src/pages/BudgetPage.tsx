...
const BUDGETS: Record<string, BudgetConfig> = {
  "ai-under-500": {
    ...
    aioSnippet: "The cheapest premium AI tools in Bangladesh under BDT 500: ChatGPT Plus Starter Shared (BDT 499/mo), Perplexity Pro Shared (BDT 499/mo), Google AI Pro (BDT 499/mo, personal account + 2TB), and Gamma (BDT 399/mo). All available via bKash or Nagad — no international credit card required. Order on WhatsApp and receive access in 5–30 minutes.",
  ...
  "ai-under-1000": {
    ...
    aioSnippet: "Premium AI tools available under BDT 1,000 per month in Bangladesh include ChatGPT Plus (from BDT 499), Google AI Pro (BDT 499), Replit Core (BDT 499), Gamma (BDT 399), Udio (BDT 499), ElevenLabs Starter (BDT 748), ChatGPT Plus Premium Shared (BDT 999), and Notion AI (BDT 800). Pay with bKash or Nagad — no international card required.",

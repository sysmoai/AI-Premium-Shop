...
export default function ProductsPage() {
  ...
  return (
    <PageLayout>
      <SEOHead
        title="All 76 AI Tools — Prices in BDT | AI Premium Shop Bangladesh"
        description="Browse 76 AI subscriptions. ChatGPT, Claude, Midjourney & more. Prices in BDT. Local payment. Fast delivery. AI Premium Shop."
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-8 py-14">
        <div className="mb-10">
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-3">All 76 AI Tools</h1>

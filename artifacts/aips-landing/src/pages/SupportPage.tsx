...
const FAQS = [
  ...
  },
  {
    ...
    a: "Yes! Join our WhatsApp Community to get AI tips, product updates, exclusive discount codes, and connect with 3,000+ AI users in Bangladesh.",
  },
  {
      ...
      <section className="max-w-4xl mx-auto px-4 md:px-8 py-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-12">
          ...
          >
            ...
            <div className="text-xs" style={{ color: "#c9ceda" }}>3,000+ members</div>

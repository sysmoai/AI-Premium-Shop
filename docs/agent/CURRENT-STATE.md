...
**Last updated:** 2026-08-07 (parallel session — global reduced-motion
support added. Not yet merged; see PR note below. Two concurrent sessions
worked this repo the same day — see this entry and the "new session" one
right below it, which landed on `main` first.)
